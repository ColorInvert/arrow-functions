...
//!Note: everything I read states that Constructors and methods cannot be converted to arrow format, and so these have been left unchanged after lots of experimentation with formatting.
...
// the joe edition of the Student constructed object.
// 2. What is "this" when joe.scopeArrow() is invoked?
// The browser window itself, it appears. Tons of diagnostic information is included.
// 3. Explain why "this" is different when an arrow function is used.
// The context for "this" is unchanged when using an arrow function, which means that it is not updated with the needed data, and will instead always refer to the browser window, making "this" unusable with arrow functions.
